...
parser.add_argument("--num-iterations", default=100, type=int, help='Number of iterations to run for the combined model. Does not include pre-training iterations.')
parser.add_argument("--pre-train", default=50, type=int, help="Total number of iterations to train generator independently prior to using combined model.")
parser.add_argument("--gen-interval", default=10, type=int, help="Iteration interval at which to train the dsicriminator.")
...
while cur_iter < num_iters:
    print('Iteration: {0}, epochs={1}, batch_size={2}'.format(cur_iter, epochs_per_iter, batch_size))
